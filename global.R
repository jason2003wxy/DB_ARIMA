...
### choices for UI
lst_val_transform <- list("original value"="val_org", 
                          "log value" = "val_log", 
                          "log difference" = "diff_log", 
                          "absolute diff" = "diff_abs", 
                          "relative diff" = "diff_rel")
...
#############################
date_US_recession = read.table(textConnection(
  "date_beg, date_end
